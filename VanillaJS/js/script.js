...
// Animated Scrolling
  ...
  $(window).scroll(function() {
    ...
    var solarinfoTop = $('#solarinfo').offset().top - topoffset,
        processsTop = $('#processs').offset().top - topoffset,
        pricingTop = $('#pricing').offset().top - topoffset,
		eventsTop = $('#events').offset().top - topoffset,
		attractionsTop = $('#attractions').offset().top - topoffset;
        

    if (windowpos > solarinfoTop) {
      $menulinks.removeClass('active');
      $('a[href$="#solarinfo"]').addClass('active');
    } //windowpos

    if (windowpos > processsTop) {
      $menulinks.removeClass('active');
      $('a[href$="#processs"]').addClass('active');
    } //windowpos

    if (windowpos > pricingTop) {
      $menulinks.removeClass('active');
  ...
  if(!isTouch) {
    ...
    var processtween = TweenMax.staggerFromTo(
      "#step2 .content",
      1, processOrigin, processDest);
